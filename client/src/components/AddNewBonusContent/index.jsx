...
///import { loginSchema } from "../../utils/addRootValidations"
import ErrorMsg from "../../customComponents/ErrorMsg";
import ErrorMessage from "../../customComponents/ErrorMessage";
import "./styles.scss";

const AddNewBonusContent = (props) => {
    ...
    return (
        <div className="AddNewBonusContent-wrapper">
            <Modal
                ...
                className="add-new-modal root-modal add-bonus-modal"
                centered
            >
                    ...
                    <>
                        ...
                        {showAddSuccess === true && (
                            <span className="rstPassSuccessMsg text-center font-medium-20 mt-3 d-flex justify-content-center align-items-center">
                                Root has been Edited successfully
                            </span>
                        )}
                    </>
                </Modal.Body>
...
export default AddNewBonusContent;
